        ...
        <footer className="w-full bg-white-grey px-4">
            <div className="max-w-360 mx-auto px-6 lg:px-20">
                ...
                <div className="flex min-[1180px]:justify-between min-[1180px]:flex-row flex-col pt-12 lg:pt-20 pb-16">
                    ...
                    {/* Right: Links + Contact — inner grid */}
                            ...
                            <ul className="space-y-3 text-gray-600 mb-8">
                                {CONTACT_ICONS.map((item, index) => (
                                    <li key={index} className="cursor-pointer hover:text-black flex items-center gap-2">
                                        <a href="" className="flex items-center gap-2 text-[14px] sm:text-[16px]">
            ...
            <div className="border-t border-custom-grey/10">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 py-6 text-center font-normal opacity-80 leading-[150%] text-black text-base">
